...
- **Removed API Key Configuration Page**: The separate page for API key configuration has been removed, as the key should be configured directly in Streamlit Cloud secrets.
- **Aligned GPT Parser Categories**: The GPT parser now uses the specific accounting categories requested, ensuring consistency in data transformation.
